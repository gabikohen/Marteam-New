"use client"; // Necesario si estás usando la carpeta /app
...
const testimonials = [
  ...
  { id: 8, name: "Jane Doe 0", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aute irure dolor in reprehenderit in voluptate velit esse." },
];

const TestimonialCard = ({ name, text }) => (
  <div className="bg-transparent bg-[radial-gradient(ellipse_at_top_left,rgba(229,192,123,0.08),transparent)] border border-white/20 rounded-2xl px-8 py-8 shadow-[0_0_15px_rgba(255,255,255,0.1)] h-full w-full flex flex-col justify-between">



    <div>
      <div className="text-[#E5C07B] mb-4 text-xl">{"★".repeat(7)}</div>
...
const Testimonial = () => {
  ...
  return (
    <div id="testimonios" className="max-w-full mx-auto px-4 py-12">
      <Slider {...settings}>
