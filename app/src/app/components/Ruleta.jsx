...
const PrizeWheel3D = ({ onClose }) => {
        ...
        <div className="fixed inset-0  flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-black/60 rounded-3xl p-6 sm:p-8 max-w-md sm:max-w-2xl w-full relative shadow-2xl border border-white/20 backdrop-blur-md">
            ...
            <div className="text-center">
              <h2 className="text-3xl font-bold text-transparent bg-gradient-to-r from-[#E5C07B] to-[#E5C07B] bg-clip-text mb-6">
                🎉 ¡Gira y Gana! 🎉
              </h2>
  ...
  isSpinning
    ...
    : 'bg-transparent text-[#E5C07B] hover:scale-105 hover:text-[#E5C07B] hover:drop-shadow-[0_0_10px_rgba(229,192,123,0.8)]'
}
  `}
>
  {isSpinning ? (
